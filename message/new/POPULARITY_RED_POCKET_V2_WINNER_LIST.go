...
const CmdPopularityRedPocketV2WinnerList = "POPULARITY_RED_POCKET_V2_WINNER_LIST"

type PopularityRedPocketV2WinnerList struct {
	LotID      int   `json:"lot_id"`    // 25109135
	TotalNum   int   `json:"total_num"` // 21
	AwardNum   int   `json:"award_num"` // 0
...
func (PopularityRedPocketV2WinnerList) Cmd() string {
	return CmdPopularityRedPocketV2WinnerList
}
